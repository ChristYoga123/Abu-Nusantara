<ul class="nav flex-column pt-3 pt-md-0">
    ...
    <li class="nav-item {{ request()->routeIs('payments.index') ? 'active' : '' }}">
        <a href="{{ route('payments.index') }}" class="nav-link">
            ...
            <span class="sidebar-text">{{ __('Pembayaran') }}</span>
        </a>
    </li>

    <li class="nav-item {{ request()->routeIs('product_categories.index') ? 'active' : '' }}">
        <a href="{{ route('product_categories.index') }}" class="nav-link">
            ...
            <span class="sidebar-text">{{ __('Kategori') }}</span>
        </a>
    </li>
    ...
    <li class="nav-item {{ request()->routeIs('products.index') ? 'active' : '' }}">
        <a href="{{ route('products.index') }}" class="nav-link">
            ...
            <span class="sidebar-text">{{ __('Produk') }}</span>
        </a>
    </li>
