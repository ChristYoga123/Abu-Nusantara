...
<div class="main py-4">
    <div class="card card-body border-0 shadow table-wrapper table-responsive">
        <h2 class="mb-4 h5">{{ __('Tambah Produk') }}</h2>
        <div class="col-lg-8">
            <form action="/admin/products/post" method="post" enctype="multipart/form-data">
                @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="product_slug" name="product_slug" required value="{{ old('product_slug') }}" readonly>
                    </div>
                    
                    <div class="mb-3">
                        <label for="product_description" class="form-label @error('product_image') is-invalid @enderror">Deskripsi</label>
                        <input type="text" class="form-control" id="product_description" name="product_description" required value="{{ old('product_description') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('product_image') is-invalod @enderror" type="file" id="product_image" name="product_image" required onchange="previewImage()">
                        <div class="my-2">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" class="form-control @error('product_price') is-invalid @enderror" name="product_price" id="product_price" required>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" class="form-control @error('product_discount_price') is-invalid @enderror" name="product_discount_price" id="product_price" value="0">
